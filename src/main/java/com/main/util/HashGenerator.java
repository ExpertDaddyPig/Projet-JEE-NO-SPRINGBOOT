...
public class HashGenerator {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("UPDATE employees SET password_hash = '" + hash + "' WHERE username = 'admin';");
            System.out.println("-".repeat(80));
            System.out.println();
        }
        ...
        for (String[] user : defaultPasswords) {
            ...
            System.out.println("-- " + username + " (password_hash: " + pwd + ")");
            System.out.println("UPDATE employees SET password_hash = '" + hash + "' WHERE username = '" + username + "';");
            System.out.println();
        }
