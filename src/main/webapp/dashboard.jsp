...
<body>
    <nav class="navbar">
        ...
        <div class="navbar-user">
            <div class="user-info">
                ...
                <div class="user-role">${currentUser.role.displayName}</div>
            </div>
    ...
    <div class="container">
        <div class="welcome-section">
            ...
            <p>Vous êtes connecté en tant que <strong>${currentUser.role.displayName}</strong></p>
            <span class="role-badge
                <c:choose>
                    <c:when test="${currentUser.role == 'ADMINISTRATEUR'}">role-admin</c:when>
                    <c:when test="${currentUser.role == 'CHEF_DEPARTEMENT'}">role-chef-dept</c:when>
                    <c:when test="${currentUser.role == 'CHEF_PROJET'}">role-chef-proj</c:when>
                    <c:otherwise>role-employe</c:otherwise>
                </c:choose>
            ">${currentUser.role.displayName}</span>
        </div>
        ...
        <div class="menu-grid">
            ...
            <a href="${pageContext.request.contextPath}/payslips" class="menu-card">
                ...
                <div class="menu-description">
                    <c:choose>
                        <c:when test="${currentUser.role == 'ADMINISTRATEUR' || currentUser.role == 'CHEF_DEPARTEMENT'}">
            ...
            <c:if test="${currentUser.role == 'ADMINISTRATEUR'}">
                <a href="${pageContext.request.contextPath}/users" class="menu-card">
                    <div class="menu-icon">🔐</div>
