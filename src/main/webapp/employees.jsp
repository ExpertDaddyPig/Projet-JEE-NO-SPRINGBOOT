        ...
        <body>
            ...
            <div class="container">
                ...
                <c:if test="${param.success eq 'add'}">
                    <div
                        ...
                        Employé ajouté avec succès.</div>
                </c:if>
                <c:if test="${param.success eq 'update'}">
                    <div
                        style="background: #cce5ff; color: #004085; padding: 15px; margin-bottom: 20px; border-radius: 5px;">
                        Employé mis à jour avec succès.</div>
                </c:if>
                <c:if test="${param.success eq 'delete'}">
                    <div
                        style="background: #f8d7da; color: #721c24; padding: 15px; margin-bottom: 20px; border-radius: 5px;">
                        Employé supprimé.</div>
                </c:if>
                    ...
                    <form id="employeeForm" method="post">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="role" id="role" required>
                                    <c:forEach var="role" items="${roles}">
                                        <c:if
                                            test="${role != 'ADMINISTRATEUR' || sessionScope.currentUser.role == 'ADMINISTRATEUR'}">
                            ...
                            <div class="form-group">
                                ...
                                <small id="pwdHelp" style="display:none; color: #666;">Laisser vide pour ne pas
                                    changer</small>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn-logout" style="background:#6c757d;"
                                onclick="closeModal('employeeModal')">Annuler</button>
            ...
            <div id="deleteModal" class="modal-overlay">
                <div class="modal-content modal-small">
                    ...
                    <p style="color: #666; margin-bottom: 25px;">Êtes-vous sûr de vouloir supprimer cet employé ? Cette
