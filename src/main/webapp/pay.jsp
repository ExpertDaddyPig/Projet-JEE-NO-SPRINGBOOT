...
<%
    // Récupérer l'utilisateur pour les vérifications Java
...
<body>
    ...
    <div class="container">
        ...
        <div class="search-section">
            ...
            <form action="${pageContext.request.contextPath}/payslips/search" method="get" class="search-form">
                <div class="form-group">
                    <label>Employé (ID)</label>
                    <input type="number" name="employe_id" value="${searchEmployeId}" placeholder="ID de l'employé">
                </div>
                <div class="form-group">
                    <label>Mois</label>
                    <select name="month">
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a href="${pageContext.request.contextPath}/payslips/view?id=${payslip.id}" 
                                               class="btn btn-info" style="padding: 6px 12px; font-size: 14px;">
                                                👁️ Voir
                                            </a>
                                            <a href="${pageContext.request.contextPath}/payslips/print?id=${payslip.id}" 
                                               class="btn btn-warning" style="padding: 6px 12px; font-size: 14px;" 
                                               target="_blank">
                                                🖨️ Imprimer
                                            </a>
                                            <% if (currentUser.getEmploye_rank() >= 3) { %>
