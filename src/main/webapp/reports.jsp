    ...
    <div class="container">
        ...
        <div class="reports-section">
            ...
            <div class="chart-container">
                <div class="bar-chart">
                    <div class="bar-item">
                        <div class="bar-label">Administrateurs</div>
                        <div class="bar-wrapper">
                            <div class="bar-fill" style="width: ${(stats.employeesByRank[4] != null ? stats.employeesByRank[4] : 0) * 100 / stats.totalEmployees}%">
                                ${stats.employeesByRank[4] != null ? stats.employeesByRank[4] : 0}
                            </div>
                        </div>
                    </div>

                    <div class="bar-item">
                        <div class="bar-label">Chefs de Département</div>
                        <div class="bar-wrapper">
                            <div class="bar-fill" style="width: ${(stats.employeesByRank[3] != null ? stats.employeesByRank[3] : 0) * 100 / stats.totalEmployees}%">
                                ${stats.employeesByRank[3] != null ? stats.employeesByRank[3] : 0}
                            </div>
                        </div>
                    </div>

                    <div class="bar-item">
                        <div class="bar-label">Chefs de Projet</div>
                        <div class="bar-wrapper">
                            <div class="bar-fill" style="width: ${(stats.employeesByRank[2] != null ? stats.employeesByRank[2] : 0) * 100 / stats.totalEmployees}%">
                                ${stats.employeesByRank[2] != null ? stats.employeesByRank[2] : 0}
                            </div>
                        </div>
                    </div>

                    <div class="bar-item">
                        <div class="bar-label">Employés</div>
                        <div class="bar-wrapper">
                            <div class="bar-fill" style="width: ${(stats.employeesByRank[1] != null ? stats.employeesByRank[1] : 0) * 100 / stats.totalEmployees}%">
                                ${stats.employeesByRank[1] != null ? stats.employeesByRank[1] : 0}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bar-chart">
                    <c:forEach var="entry" items="${stats.employeesByDepartment}">
                        <div class="bar-item">
                            ...
                            <div class="bar-wrapper">
                                <div class="bar-fill" style="width: ${entry.value * 100 / stats.totalEmployees}%">
                                    ${entry.value}
                                </div>
                            </div>
                        </div>
                ...
                <div class="bar-chart">
                    <c:forEach var="entry" items="${stats.employeesByProject}">
                        <div class="bar-item">
                            <div class="bar-label">${entry.key}</div>
                            <div class="bar-wrapper">
                                <div class="bar-fill" style="width: ${entry.value * 10}%">
                                    ${entry.value}
                                </div>
                            </div>
                        </div>
        ...
        <div class="reports-section">
            ...
            <div class="quick-actions">
                <a href="${pageContext.request.contextPath}/reports/departments" class="action-card">
